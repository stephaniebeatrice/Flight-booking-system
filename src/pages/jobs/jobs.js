...
import "./style.css";
import { JobCard } from "../../components/rows";
              ...
              <div className="job-overview">
                <div className="job-overview-cards">
                    ...
                    <div className="job-card overview-card">
                      <div className="overview-wrapper">
                        ...
                        <div className="overview-detail">
                          ...
                          <div className="job-card-subtitle">2972 Westheimer Rd. Santa Ana.</div>
                        </div>
                        <svg
                    ...
                    <div className="job-card overview-card">
                      <div className="overview-wrapper">
                        ...
                        <div className="overview-detail">
                          ...
                          <div className="job-card-subtitle">1901 Thornridge Cir.Shiloh, Hawaii.</div>
                        </div>
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          viewBox="0 0 24 24"
                    ...
                    <div className="job-card overview-card">
                      <div className="overview-wrapper">
                        ...
                        <div className="overview-detail">
                          ...
                          <div className="job-card-subtitle">414 Parker Rd. Allentown, New york</div>
                        </div>
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          viewBox="0 0 24 24"
                    ...
                    <div className="job-card overview-card">
                      <div className="overview-wrapper">
                        ...
                        <div className="overview-detail">
                          ...
                          <div className="job-card-subtitle">4517 Washington Ave. Syracuse.</div>
                        </div>
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          viewBox="0 0 24 24"
                  ...
                  <div className="job-overview-card">
                    <div className="job-card overview-card">
                      <div className="overview-wrapper">
                        ...
                        <div className="overview-detail">
                          <div className="job-card-title">UI / UX Designer</div>
                          <div className="job-card-subtitle">2711 Ash Dr. San Jose, South Dark.</div>
                        </div>
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          viewBox="0 0 24 24"
                    ...
                    <div className="job-card overview-card">
                      <div className="overview-wrapper">
                        ...
                        <div className="overview-detail">
                          ...
                          <div className="job-card-subtitle">1725 Preston Rd. Inglewood.</div>
                        </div>
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          viewBox="0 0 24 24"
                  ...
                  <div className="job-overview-card">
                    <div className="job-card overview-card">
                      <div className="overview-wrapper">
                        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#fff" style={{ backgroundColor: " #ea4c88" }}>
                        ...
                        <div className="overview-detail">
                          <div className="job-card-title">UI / UX Designer</div>
                          <div className="job-card-subtitle">1976 Thornide Joshua. Andr Maria.</div>
                        </div>
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          viewBox="0 0 24 24"
                  ...
                  <div className="job-explain-content">
                    ...
                    <div className="overview-text">
                      ...
                      <div className="overview-text-subheader">
                        We believe that design (and you) will be critical to the company's success. You will work with our founders and our early
                        customers to help define and build our product functionality, while maintaining the quality bar that customers have come to
                        expect from modern SaaS applications. You have a strong background in product design with a quantitavely anf qualitatively
                        analytical mindset. You will also have the opportunity to craft our overall product and visual identity and should be
