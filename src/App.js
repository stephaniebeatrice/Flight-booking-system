	...
	return (
		<Router>
			<Routes>
				...
				<Route
					path="/TicketEdit"
					element={renderRestrictedComponent(ticketEditing)}
				/>
				<Route
					path="/Notification"
					element={renderRestrictedComponent(Notification)}
				/>
				<Route
					path="/EmployeeMatching"
					element={renderRestrictedComponent(EmployeeMatching)}
				/>
