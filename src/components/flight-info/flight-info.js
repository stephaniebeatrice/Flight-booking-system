  ...
  return (
    <main>
      <form onSubmit={handleSearch}>
        <input type="text" name="dep_date" value={depDate} onChange={e => setDepDate(e.target.value)} placeholder="Departure Date" />
        <input type="text" name="ret_date" value={retDate} onChange={e => setRetDate(e.target.value)} placeholder="Return Date" />
        <input type="text" name="dep_city" value={depCity} onChange={e => setDepCity(e.target.value)} placeholder="Departure City" />
        <input type="text" name="arr_city" value={arrCity} onChange={e => setArrCity(e.target.value)} placeholder="Arrival City" />
        <input type="text" name="type" value={type} onChange={e => setType(e.target.value)} placeholder="Type" />
        <input type="text" name="f_class" value={fClass} onChange={e => setFClass(e.target.value)} placeholder="Flight Class" />
        <input type="text" name="passengers" value={passengers} onChange={e => setPassengers(e.target.value)} placeholder="Passengers" />
              ...
              {searchResults.map(row => {
                ...
                return (
                  <tr className="text-center" key={row.flight_id}>
                    ...
                    <td>
                      <div>
                        <div className={`alert ${alert} text-center mb-0 pt-1 pb-1`} role="alert">
                          {status}
                        </div>
                      </div>
                    </td>
                    ...
                    {row.status === "" && (
                      <td>
                        <form method="post">
                          ...
                          <input name="ret_date" type="hidden" value={retDate} />
                          <input name="class" type="hidden" value={fClass} />
                          <button name="book_but" type="submit" className="btn btn-success mt-0">
                            <div>
