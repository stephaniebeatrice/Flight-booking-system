        ...
        <div className="wrapper">
          <div className="booking-widget">
            ...
            <div className="booking-form">
              ...
              <div ref={psnlInfoRef} id="psnlInfo" className="booking-tab-content active">
            ...
            <div ref={seatSelectRef} id="seatSelect" className="booking-tab-content">
              ...
              <div className="tab-wrapper">
                ...
                <div id="checkIn" className="active" style={{ padding: "14px 0 0 0" }}>
                  <div className="fieldset third">
                    <div className="field">
                      <label id="lbl_seatSelectBRN" aria-label="Booking Reference Number">
                        Booking Reference Number
                      </label>
                      <div className="input-wrapper icon-book-flight">
                        <input
                          name="ctl00$ctBody$Web_Content_Home$BookingEngine$OnlineCheckin$seatSelectBRN"
                          type="text"
                          id="seatSelectBRN"
                          autoComplete="off"
                          className="textbox txtBRN"
                          aria-labelledby="lbl_seatSelectBRN"
                    ...
                    <div className="field field-etn">
                      <div className="inline-fields">
                        ...
                        <div className="inline-field">
                          <label id="lbl_seatSelectETNCode" aria-label="E-Ticket Number">
                            E-Ticket Number
                          </label>
                          <div className="inline-fields">
                            <div className="inline-field etncode">
                              <div className="input-wrapper icon-book-flight">
                                <input
                                  name="ctl00$ctBody$Web_Content_Home$BookingEngine$OnlineCheckin$seatSelectETNCode"
                                  type="number"
                                  id="seatSelectETNCode"
                                  autoComplete="off"
                            ...
                            <div className="inline-field etn">
                              <div className="input-wrapper no-icon">
                                <input
                                  name="ctl00$ctBody$Web_Content_Home$BookingEngine$OnlineCheckin$seatSelectETN"
                                  type="number"
                                  id="seatSelectETN"
                                  autoComplete="off"
                                  className="textbox txtETN"
                    ...
                    <div className="field">
                      <div className="inline-fields">
                        <div className="or inline-field">Or</div>
                        <div className="inline-field">
                          <label id="lbl_seatSelectFFN" aria-label="Frequent Flyer Number">
                          ...
                          <div className="inline-fields">
                            <div className="inline-field ffn-airline">
                              <div className="input-wrapper icon-book-flight">
                                <select
                                  name="ctl00$ctBody$Web_Content_Home$BookingEngine$OnlineCheckin$seatSelectFFNAirline"
                                  id="seatSelectFFNAirline"
                                  className="seatSelectFFNAirline select2-hidden-accessible"
                                  aria-label="Select the Frequent Flyer airline"
                                  style={{ width: "100%" }}
                                  data-select2-id="seatSelectFFNAirline"
                                  tabIndex={-1}
                                  aria-hidden="true"
                                >
                                ...
                                >
                                  <span className="selection">
                                    <span
                                      ...
                                      aria-expanded="false"
                                      tabIndex={0}
                                      aria-labelledby="select2-seatSelectFFNAirline-container"
                                    >
                                      <span
                                        className="select2-selection__rendered"
                                        id="select2-seatSelectFFNAirline-container"
                                        role="textbox"
                                        aria-readonly="true"
                                      >
                            ...
                            <div className="inline-field ffn">
                              <div className="input-wrapper no-icon">
                                <input
                                  name="ctl00$ctBody$Web_Content_Home$BookingEngine$OnlineCheckin$seatSelectFFN"
                                  type="number"
                                  id="seatSelectFFN"
                                  autoComplete="off"
                                  className="textbox txtETN seatSelectFFN"
                  ...
                  <div className="fieldset two-thirds">
                    <div className="field">
                      <label id="lbl_seatSelectLastName">Last Name*</label>
            ...
            <div ref={paymentRef} id="payment" className="booking-tab-content">
                ...
                <div id="manageBooking" className="pill-tab-content active">
                  <div className="fieldset two-thirds">
                    <div className="field">
                      <div className="inline-fields">
                        <div className="inline-field">
                          <label id="lbl_flightTicketLastName" aria-label="Last Name">
                            Last Name*
                          </label>
                          <div className="input-wrapper icon-passenger">
                            <input
                              name="ctl00$ctBody$Web_Content_Home$BookingEngine$ManageMyBooking$flightTicketLastName"
                              type="text"
                              id="flightTicketLastName"
                              className="textbox txtname"
                              aria-labelledby="lbl_flightTicketLastName"
                              placeholder="Enter Last Name"
                            />
                          </div>
                        </div>
                        <div className="inline-field mngBkBRN">
                          <label id="lbl_flightTicketBRN" aria-label="Booking Reference Number">
                            Booking Reference Number
                          </label>
                          <div className="input-wrapper icon-book-flight">
                            <input
                              name="ctl00$ctBody$Web_Content_Home$BookingEngine$ManageMyBooking$flightTicketBRN"
                              type="text"
                              id="flightTicketBRN"
                              autoComplete="off"
                              className="textbox txtBRN"
                              aria-labelledby="lbl_flightTicketBRN"
                              placeholder="e.g. AZ6E7G"
                              maxLength={6}
                            />
                          </div>
                    ...
                    <div className="field">
                      <div className="inline-fields">
                        <div className="or inline-field">Or</div>
                        <div className="inline-field">
                          <label id="lbl_flightTicketETNCode" aria-label="E-Ticket Number">
                            E-Ticket Number
                          </label>
                          <div className="inline-fields">
                            <div className="inline-field etncode">
                              <div className="input-wrapper icon-book-flight">
                                <input
                                  name="ctl00$ctBody$Web_Content_Home$BookingEngine$ManageMyBooking$flightTicketETNCode"
                                  type="number"
                                  id="flightTicketETNCode"
                                  className="textbox txtETN"
                                  placeholder="(706)"
                                  aria-label="Enter the first three digits of the e-ticket number"
                                  maxLength={3}
                            ...
                            <div className="inline-field etn">
                              <div className="input-wrapper no-icon">
                                <input
                                  name="ctl00$ctBody$Web_Content_Home$BookingEngine$ManageMyBooking$flightTicketETN"
                                  type="number"
                                  id="flightTicketETN"
                                  className="textbox txtETN"
                                  aria-label="Enter the last ten digits of the e-ticket number"
            ...
            <div ref={flightTicketRef} id="flightTicket" className="booking-tab-content">
                  ...
                  <div className="fieldset fifth">
                    <div className="field one">
                      ...
                      <div className="input-wrapper dd icon-from">
                        <input
                          name="ctl00$ctBody$Web_Content_Home$BookingEngine$payment$fltTimeDepart"
                          type="text"
                          id="fltTimeDepart"
                    ...
                    <div className="field two">
                      ...
                      <div className="input-wrapper dd icon-to">
                        <input
                          name="ctl00$ctBody$Web_Content_Home$BookingEngine$payment$fltTimeArrival"
                          type="text"
                          id="fltTimeArrival"
                    ...
                    <div className="field three">
                      ...
                      <div className="input-wrapper dd icon-book-flight">
                        <select
                          name="ctl00$ctBody$Web_Content_Home$BookingEngine$payment$fltTimeTrip"
                          id="fltTimeTrip"
                    ...
                    <div className="field four date-field trip-return">
                      ...
                      <div className="input-wrapper dates has-arrow icon-calendar">
                        <div className="date-field-wrapper date-depart">
                          <input
                            name="ctl00$ctBody$Web_Content_Home$BookingEngine$payment$fltTblDepartDate"
                            type="component"
                            id="fltTblDepartDate"
                            autoComplete="off"
                        ...
                        <div className="date-field-wrapper date-return">
                          <input
                            name="ctl00$ctBody$Web_Content_Home$BookingEngine$payment$fltTblReturnDate"
                            type="component"
                            id="fltTblReturnDate"
                            autoComplete="off"
                    ...
                    <div className="field four date-field trip-oneway">
                      ...
                      <div className="input-wrapper dates has-arrow icon-calendar">
                        <input
                          name="ctl00$ctBody$Web_Content_Home$BookingEngine$payment$fltTimeDepartDate"
                          type="component"
                    ...
                    <div className="field five">
                      <input
                        type="submit"
                        name="ctl00$ctBody$Web_Content_Home$BookingEngine$payment$cmdGetMyTimetable"
                        value="Go"
