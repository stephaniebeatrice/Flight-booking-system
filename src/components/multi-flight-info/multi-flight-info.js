...
const MultiFlightLogo = props => {
  return <img src={multiFlightLogo} alt="multiple flights logo" width="12" height="12" />;
};
...
export const MultiFlightInfo = props => {
  const {
    cumulativeFlight: { departureTime, origin, arrivalTime, destination, totalFare, arrivalTimeStamp, departureTimeStamp, dayChange },
    flights,
  } = props.data;
